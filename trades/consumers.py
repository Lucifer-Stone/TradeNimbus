...
from trades.models import StockDetail
...
class StockConsumer(AsyncWebsocketConsumer):
    ...
    def addToCeleryBeat(self, stockpicker):
        ...
        if len(task) > 0:
            ...
            task = PeriodicTask.objects.create(interval = schedule, name='every-10-seconds', task="trades.tasks.update_stock", args = json.dumps([stockpicker]))
